...
public interface FileUploadRepository extends JpaRepository<FileUpload, Long> {
    ...
    @Query("select new com.melardev.spring.shoppingcartweb.models.extensions.ProductImageExtension(f.product.id, f.filePath) from FileUpload f where f.product.id=:id")
    Collection<ProductImage> findAllWhereProductIdIs(Long id);
}
